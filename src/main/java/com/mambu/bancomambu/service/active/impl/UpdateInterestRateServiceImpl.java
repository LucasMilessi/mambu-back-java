...
@Service
public class UpdateInterestRateServiceImpl implements UpdateInterestRateService {
    ...
    @Override
    public Mono<Object> updateInterest(String id, InterestRateDTO interestRateDTO) {

        return mambuConfig.getClient().post()
                .uri("/loans/"+id+":changeInterestRate")
                .body(Mono.just(interestRateDTO), InterestRateDTO.class)
