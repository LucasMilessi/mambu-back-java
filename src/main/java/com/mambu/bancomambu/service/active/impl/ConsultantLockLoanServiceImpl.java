...
import com.mambu.bancomambu.service.active.ConsultantLockLoanService;
...
@Service
public class ConsultantLockLoanServiceImpl implements ConsultantLockLoanService {
    ...
    @Override
    public Flux<LoanDTO> lockConsultantLoan(RequestTransactionDTO transactionDTO) {
