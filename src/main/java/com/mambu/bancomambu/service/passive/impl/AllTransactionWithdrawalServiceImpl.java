...
@Service
public class AllTransactionWithdrawalServiceImpl implements AllTransactionWithdrawalService {
    ...
    @Override
    public Flux<WithdrawalDTO> allTransactionWithdrawal(String offset, String limit, String paginationDetails,
