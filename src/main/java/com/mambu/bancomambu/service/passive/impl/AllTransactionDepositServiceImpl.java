...
@Service
public class AllTransactionDepositServiceImpl implements AllTransactionDepositService {
    ...
    @Override
    public Flux<TransactionDTO> allTransaction(String offset, String limit, String paginationDetails,
