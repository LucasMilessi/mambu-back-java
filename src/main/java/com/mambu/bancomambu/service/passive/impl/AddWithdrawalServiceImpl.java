...
@Service
public class AddWithdrawalServiceImpl implements AddWithdrawalService {
    ...
    @Override
    public Mono<WithdrawalDTO> addWithdraw(String depositAccountId, WithdrawalDTO withdrawalDTO) {

        return mambuConfig.getClient().post()
                .uri("/deposits/"+depositAccountId+"/withdrawal-transactions")
                .body(Mono.just(withdrawalDTO), WithdrawalDTO.class)
